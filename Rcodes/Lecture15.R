...
quartz()
par(mfrow=c(2,3))
plot(betaestList[[1]]$fd, lwd=2, xlab="Day", ylab="Mean Temperature", main=regions[1],cex.lab=4,cex.axis=4)
for (j in 2:p) plot(betaestList[[j]]$fd, lwd=2, xlab="Day", ylab="Difference", main=regions[j],cex.lab=4,cex.axis=4)
